...
async function getAllPermissions() {
  ...
  // Set all permissions to Super Admin role
...
const DEFAULT_PERMISSIONS = [
  ...
  { action: 'authenticate', controller: 'auth', type: 'users-permissions', roleType: 'public' },
  ...
  { action: null, controller: null, type: null, roleType: 'super_admin' },
  { action: null, controller: 'user', type: 'application', roleType: 'public' },
  { action: 'findone', controller: 'user', type: 'application', roleType: 'authenticated' },

  { action: null, controller: 'recruitment', type: 'application', roleType: 'authenticated' },
  { action: 'find', controller: 'recruitment', type: 'application', roleType: 'public' },
  { action: 'findone', controller: 'recruitment', type: 'application', roleType: 'public' },
];
...
module.exports = {
  async createSuperAdminRole(name = 'Super Admin', description = 'Role for super admin') {
    // Get all permissions
